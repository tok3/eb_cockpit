...
{{ theme:image file="banner_register.jpg" alt="Online Energieausschreibung" }}
	...
	<?php endif;?>
		<?php echo form_open('cockpit/affiliate/register', array('id' => 'register')) ?>
...
<!-- agb -->
	<div class="row">
			<div class="large-12 columns">
     <label><input type="checkbox" name="agb" id="agb"/>&nbsp;Ich habe die <?php echo anchor('impressum/Affiliate-Nutzungsbedingungen','Nutzungsbedingungen des Partnerprogramms','target="_blank"');?> gelesen und akzeptiere diese.	</label>
			</div></div>
