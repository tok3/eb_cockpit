        <header class="header">
            <a href="<?php echo site_url();?>" class="logo">
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
					  {{ asset:image file="module::logo.png" alt="Logo Ihre Energieberater" class="logo-cockpit"}}
            </a>
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu hide">
                            ...
                            <ul class="dropdown-menu">
                                <li class="header">Sie haben 1 Benachrichtigung</li>
                                <li>
                                    <!-- inner menu: contains the actual data -->
                                    <ul class="menu">
                                        <li>
                                            <a href="<?php echo site_url('cockpit/documents/index');?>">
                                                <i class="fa fa-exchange success"></i> 
<small>
Letzter Schritt zu Ihrer Energieausschreibung
</small>
                                            </a>
                                        </li>
                                    </ul>
