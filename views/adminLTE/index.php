...
{{ asset:image file="module::avatar.png" alt="Company Logo" class="img-circle"}}
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
{{ asset:image file="module::avatar3.png" alt="Company Logo" class="img-circle"}}
...
{{ asset:image file="module::avatar.png" alt="Company Logo" class="img-circle"}}
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
{{ asset:image file="module::avatar2.png" alt="Company Logo" class="img-circle"}}
                                                </div>
                                                <h4>
                                                    Sales Department
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    <!-- chat item -->
                                    <div class="item">
{{ asset:image file="module::avatar.png" alt="Company Logo" class="online"}}
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
{{ asset:image file="module::avatar2.png" alt="Company Logo" class="offline"}}
                                    ...
                                    <!-- chat item -->
                                    <div class="item">
{{ asset:image file="module::avatar.png" alt="Company Logo" class="offline"}}
